...
export const logo=(compact=false,subtitle='MEASURABLE PROGRESS')=>`<span class="brand-symbol" aria-hidden="true"><svg viewBox="0 0 44 44" aria-hidden="true" focusable="false"><path class="logo-orbit" d="M7 35V9l15 16L37 9v26"/><path class="logo-axis" d="M7 38h30M11 35v6M22 35v6M33 35v6"/><circle class="logo-point" cx="37" cy="9" r="3"/></svg></span>${compact?'':`<span class="brand-word"><b>MARKOVLAB</b><small>${subtitle}</small></span>`}`;
